...
public class Home extends NavigationBar {
    ...
    public Home typeDownPayment(String value){
        LOGGER.debug("TypingDownPayment value: " + value);
        ActOn.element(driver,DownPaymentInputFiled).setValue(value);
        return this;
    }
    public Home clickDownPaymentInDollar(){
        LOGGER.debug("Clicking obn the $ radio button ");
    ...
    public Home typeLoanTermYears(String value){
        ...
        ActOn.element(driver,LoantermtInputField).setValue(value);
        return this;
    }
    ...
    public Home typePropertyTax(String value){
        ...
        ActOn.element(driver,PropertyTaxInputFiled).setValue(value);
        return this;
    }
    ...
    public Home typeHomeOwnerInsurance(String value){
        ...
        ActOn.element(driver,HomeInsInputFiled).setValue(value);
        return this;
    }
    ...
    public Home selectLoanType(String value){
        LOGGER.debug("Typing the loan Type: " + value);
